...
import { Sparkles, ArrowLeft, ArrowRight, Upload, Store, Palette, Sliders, Eye, Download, Check } from "lucide-react";
            ...
            {currentStep === 0 && (
              <div className="text-center">
                ...
                <label className="block max-w-md mx-auto cursor-pointer">
                  <div className="border-2 border-dashed border-border rounded-2xl p-16 hover:border-primary/40 transition-colors bg-card">
                    {uploadedFile ? (
                      <div className="text-center">
                        <div className="w-20 h-20 rounded-xl bg-primary/10 mx-auto mb-4 flex items-center justify-center">
            ...
            {currentStep === 4 && (
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground mt-4">
                  AI processing will generate the enhanced version when connected to backend
                </p>
              </div>
            )}
